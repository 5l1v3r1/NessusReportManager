...
<div class="span10">
          <div class="hero-unit golge-ve-gecikme">
            <div class="row-fluid">
                <div class="span4">
                    <h5 class="Main-Menu-Mehmet"><i class="icon-info-sign"></i> SYSTEM INFORMATION</h5>
                    <p class="text-info"><b>IP Adress:</b> 192.168.120.130</p>
                    <p class="text-info"><b>OS:</b> <?=ServerOS()?></p>
                    <p class="text-info"><b>OS Version:</b> <?=  ServerVersion()?></p>
                    <p class="text-info"><b>OS Architecture:</b> <?= ServerArchitecture()?></p>
                    <p class="text-info"><b>Hostname:</b> <?=ServerHostname()?></p>
