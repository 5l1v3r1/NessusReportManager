         ...
         <div class="hero-unit golge-ve-gecikme">
             <div class="row-fluid">
                 ...
                 <div>
                     ...
                     <br>
                     <br>
                     <a class="btn btn-primary" href="<?= base_url()."index.php/reportgenerator/ExploitablereportByVulns/".html_escape($report_data->ReportID)?>" target="_blank">
                         Exploitable by Vulnerability
                     </a>                     
                 </div>
         </div>
     </div>
