...
<head>
    ...
    <script type="text/javascript" src="<?=base_url()."js/highstock.js";?>"></script>
    <script type="text/javascript" src="<?=base_url()."js/adapters/prototype-adapter.js";?>"></script>
    <style type="text/css">
      body {
      	padding-top: 0px;
        padding-bottom: 40px;
...
<!--Top 10 Vulnerability Rate-->
    ...
    {   
        // if host dont have any vulnerabilitiy! Dont print it!
        if(sizeof($row->VulnID) == 0)
            continue;
        echo '<div class="container">';
        echo '<div class="kaydir golge-ve-gecikme">';
        echo '<h3 class ="text-success">'.html_escape($row->Name)."</h3>";
        foreach ($row->VulnID as $vuln_detail) 
        {
        ?>                 
        <div>
            <hr>
            <h4 class="text-error">Vulnerability Name : <?=html_escape($vuln_detail->Name)?></h4>
            <div class="row-fluid">
                <div class="span4">                
                    <?
                    if($vuln_detail->Severity == 4)
                        ...
                        echo '<b class="text-warning">Risk Factor : <span class="btn btn-info disabled">'.html_escape($vuln_detail->RiskFactor)."</span></b>";
